...
def _(context):
    context.cursor.execute(
        ...
        INSERT INTO test VALUES
            ...
            (-2, 2, 2.0, '2', 'null', '2012-05-31', '2012-05-31 11:20:00'),
            (-3, 3, 3.0, '3', 'NULL', '2016-04-04', '2016-04-04 11:30:00')
        """
    )
    expected = [
        (-1, 1, 1.0, "1", None, date(2011, 3, 6), datetime(2011, 3, 6, 6, 20)),
        (-2, 2, 2.0, "2", "null", date(2012, 5, 31), datetime(2012, 5, 31, 11, 20)),
...
def _(context):
    values = [
        ...
        (-2, "2", 2.0, "2", "null", "2012-05-31", "2012-05-31T11:20:00Z"),
        ["-3", 3, 3.0, "3", "NULL", "2016-04-04", "2016-04-04T11:30:00Z"],
    ]
