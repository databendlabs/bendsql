...
class BlockingDatabendCursor:
    @property
    def description(self) -> list[tuple[str, str, int | None, int | None, int | None, int | None, bool | None]]: ...
    @property
    def rowcount(self) -> int: ...
    def close(self) -> None: ...
    def execute(self, operation: str, params: list[str] | tuple[str] = None) -> None | int: ...
    def executemany(self, operation: str, params: list[list[str] | tuple[str]]) -> None | int: ...
